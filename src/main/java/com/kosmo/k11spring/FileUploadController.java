...
public class FileUploadController {
	...
	/*
	 view호출x(void), method에서 필요한 객체들
	 (request, response, session 등)을 인자로 설정하여 
	 컨트롤러에서 사용 가능
	 */
	//서버의 물리적 경로 확인하기
	...
	public String uploadAction(Model model, MultipartHttpServletRequest req) {
		...
		try {
			//업로드폼의 file속성 필드를 가져온다.(여기서는 2개임)
			...
			while(itr.hasNext()) {
				...
				//위 4가지 정보를 저장한 Map을 ArrayList에 저장
